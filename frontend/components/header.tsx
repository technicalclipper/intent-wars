    ...
    <header className="border-b border-primary/40 bg-gradient-to-r from-card via-card to-card/80 backdrop-blur-xl">
      <div className="flex items-center justify-between px-8 py-5">
        ...
        <div className="flex items-center gap-6">
          ...
          <button className="px-6 py-2.5 rounded-lg bg-gradient-to-r from-primary to-secondary text-primary-foreground hover:shadow-lg hover:shadow-primary/50 transition-all duration-300 font-bold uppercase text-xs tracking-wider glow-effect">
            Connect Wallet
          </button>
        </div>
      </div>
